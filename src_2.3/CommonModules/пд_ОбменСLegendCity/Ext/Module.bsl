...
Функция ПолучитьНастройкиИнтеграции() Экспорт
	...
	НастройкиИнтеграции.ИдентификаторТерминала = НастройкиИнтеграции.ТаблицаИдентификаторТерминала.Найти(ПараметрыСеанса.ТекущийМагазин).ИдентификаторТерминала;
